    ...
    <>
      ...
      <Collapse in={reportsOpen} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          ...
          <ListItemButton component={Link} to="/hospital/reports/patients" sx={{ pl: 4, color: 'white', '&:hover': { bgcolor: 'rgba(255,255,255,0.1)' } }}>
          ...
          <ListItemButton component={Link} to="/hospital/reports/departments" sx={{ pl: 4, color: 'white', '&:hover': { bgcolor: 'rgba(255,255,255,0.1)' } }}>
